                ...
                <div class="row">
                    <div id="carouselRevvo" class="carousel slide carousel-fade">
                        <div class="carousel-indicators">
                            <button type="button" data-bs-target="#carouselRevvo" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                            <button type="button" data-bs-target="#carouselRevvo" data-bs-slide-to="1" aria-label="Slide 2"></button>
                            <button type="button" data-bs-target="#carouselRevvo" data-bs-slide-to="2" aria-label="Slide 3"></button>
                        </div>
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item <?= $key === 0 ? 'active' : '' ?>">
                                ...
                                <div class="carousel-caption z-3 d-none d-md-block">
                                    ...
                                    <a class="btn btn-outline-light btn-custom-primary" href="<?= BASE_URL . 'cursos/' . $item['id'] ?>">Ver Curso</a>
                                </div>
                            </div>
                            <?php endforeach; ?>
                        </div>
                    ...
                    <div class="grid-cursos">
                        <div class="row row-cols-4 g-4">
                            <?php foreach($data['cursos'] as $key => $item): ?>
                                <div class="col">
                                    <div class="card">
                                        <img src="<?= BASE_URL . 'src' . $item['image_url'] ?>" class="card-img-top" alt="<?= htmlspecialchars($item['title']) ?>">
                                        <div class="card-body">
                                            <h3 class="card-title"><?= $item['title'] ?></h3>
                                            <p class="card-text"><?= implode(' ', array_slice(explode(' ', htmlspecialchars($item['content'])), 0, 15)) . '...' ?></p>
                                            <a class="btn btn-dark btn-custom-primary" href="<?= BASE_URL . 'cursos/' . $item['id'] ?>">Ver Curso</a>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                            <div class="col">
                                <a class="btn btn-link btn-custom-create" href="<?= BASE_URL ?>cursos/create">
    ...
    <section id="bottom">
        <div class="container">
            <div class="row d-flex flex-row">
                <div class="logo">
                    <img class="logo logo-light" src="<?= BASE_URL . 'src/assets/images/logo-light.png' ?>" alt="<?= htmlspecialchars($item['title']) ?>">
                    <p class="text">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                </div>
                <div class="contact">
                    <h3 class="title">// Contato</h3>
                    <p class="text">(45) 98765-4321<br />contato@leolearning.com</p>
                </div>
